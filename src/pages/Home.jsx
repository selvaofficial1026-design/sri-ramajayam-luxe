...
export default function Home({ setActivePage }) {
  ...
  return (
    <div className="animate-fade-in">
      ...
      >
        <div style={{ position: 'absolute', inset: 0, opacity: 0.35, backgroundImage: "url('https://images.unsplash.com/photo-1566665797739-1674de7a421a?q=80&w=1600&auto=format&fit=crop')", backgroundSize: 'cover', backgroundPosition: 'center', filter: 'brightness(0.7)' }} />
      ...
      {/* ---------- KEY STATS BAR ---------- */}
      <section style={{ background: 'var(--sapphire-900)', borderTop: '1px solid rgba(200, 169, 107, 0.3)', borderBottom: '1px solid rgba(200, 169, 107, 0.3)', padding: '30px 0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '20px', textAlign: 'center' }}>
            {[
              ...
              <div key={idx} style={{ padding: '8px' }}>
                <div style={{ fontSize: 'clamp(24px, 3.5vw, 32px)', fontFamily: 'var(--font-serif)', fontWeight: 700, color: 'var(--gold)', marginBottom: '4px' }}>
                  {stat.num}
                </div>
      ...
      {/* ---------- DUAL SHOWCASE SECTION (MEDIUM & COMPACT CARDS) ---------- */}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '28px' }}>
            ...
            >
              <div style={{ position: 'relative', height: '210px', overflow: 'hidden' }}>
                ...
                />
                <div style={{ position: 'absolute', top: '14px', left: '14px', background: 'var(--emerald-800)', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
                  Serene Stays
                </div>
              </div>
              <div style={{ padding: '24px 26px', display: 'flex', flexDirection: 'column', flex: 1, justifyItems: 'space-between' }}>
                <div>
                  <h3 style={{ fontSize: '22px', color: 'var(--emerald-900)', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '20px' }}>
                    <span style={{ fontSize: '12px', background: 'var(--emerald-50)', color: 'var(--emerald-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>✨ Smart LED TV & Wi-Fi</span>
                    <span style={{ fontSize: '12px', background: 'var(--emerald-50)', color: 'var(--emerald-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>🍽️ 24/7 Room Service</span>
                    <span style={{ fontSize: '12px', background: 'var(--emerald-50)', color: 'var(--emerald-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>❄️ Central AC</span>
                  </div>
                </div>
                <div style={{ marginTop: 'auto' }}>
                  <span className="btn btn-outline-emerald" style={{ width: '100%', padding: '10px 18px', fontSize: '13px' }}>
                    Explore Rooms & Tariffs <ArrowRight size={15} />
                  </span>
                </div>
              </div>
            </div>

            {/* Compact Card 2: Party Hall */}
            <div
              onClick={() => handleNav('party-hall')}
              className="glass-card"
              style={{
            ...
            >
              <div style={{ position: 'relative', height: '210px', overflow: 'hidden' }}>
                <img
                  ...
                  onMouseOut={(e) => (e.currentTarget.style.transform = 'scale(1)')}
                />
                <div style={{ position: 'absolute', top: '14px', left: '14px', background: 'var(--sapphire-800)', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '11px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
                  Majestic Banquets
                </div>
              </div>
              <div style={{ padding: '24px 26px', display: 'flex', flexDirection: 'column', flex: 1, justifyItems: 'space-between' }}>
                <div>
                  <h3 style={{ fontSize: '22px', color: 'var(--sapphire-900)', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', marginBottom: '20px' }}>
                    <span style={{ fontSize: '12px', background: 'var(--sapphire-50)', color: 'var(--sapphire-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>🏛️ 500-800 Pax Capacity</span>
                    <span style={{ fontSize: '12px', background: 'var(--sapphire-50)', color: 'var(--sapphire-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>🎵 Bose Sound System</span>
                    <span style={{ fontSize: '12px', background: 'var(--sapphire-50)', color: 'var(--sapphire-800)', padding: '4px 10px', borderRadius: '6px', fontWeight: 600 }}>💐 Custom Decor</span>
                  </div>
                </div>
                <div style={{ marginTop: 'auto' }}>
                  <span className="btn btn-outline-sapphire" style={{ width: '100%', padding: '10px 18px', fontSize: '13px' }}>
                    View Halls & Specifications <ArrowRight size={15} />
                  </span>
                </div>
              </div>
            </div>
      ...
      {/* ---------- OUR HERITAGE STORY ---------- */}
      <section style={{ padding: '70px 0', background: 'var(--beige)', borderTop: '1px solid rgba(0,0,0,0.06)' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '44px', alignItems: 'center' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: '#fff', padding: '12px 16px', borderRadius: '12px', border: '1px solid rgba(0,0,0,0.08)', flex: '1 1 180px' }}>
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ position: 'relative', height: 'clamp(280px, 50vw, 400px)', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 15px 30px rgba(0,0,0,0.15)', border: '4px solid #fff' }}>
              <img
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '22px' }}>
            {[
              ...
              <div key={idx} className="glass-card" style={{ background: '#fff', padding: '26px', borderRadius: '18px', display: 'flex', flexDirection: 'column', justifyItems: 'space-between', border: '1px solid rgba(0,0,0,0.06)' }}>
                <div>
      ...
      {/* ---------- CTA BANNER ---------- */}
      <section style={{ background: 'linear-gradient(135deg, var(--emerald-900) 0%, var(--sapphire-900) 100%)', color: '#fff', padding: '60px 0', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '700px' }}>
          ...
          <button onClick={() => handleNav('contact')} className="btn btn-gold" style={{ padding: '12px 26px', fontSize: '13px' }}>
